package co.istad.ai_interview_app.config.specification;

import co.istad.ai_interview_app.config.filter.RequestDto;
import co.istad.ai_interview_app.config.filter.SearchRequestDto;
